...
- **Ulanish nuqtasi**: backend `identity_provider.py` — `IdentityProviderBase.start/verify`, `MyIdProvider`/`OneIdProvider` adapterlar, demo rejimda `demo_code`; MyID kelganda faqat adapter to'ldiriladi (§1 ✅).
